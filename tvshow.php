...
<body>
    ...
    if (!$reviewresult)
                        {
                            echo "Could not connect to tvshows reviews";
                            exit();
                        }
     $castquery = 'select actors.name from actors,tvcast where tvcast.pid=actors.pid and tvcast.tvid='.$tvid.';';
     //echo $castquery;
    ...
    <div class="container">
        <div class="row">
            ...
            <div style=\"float:right\" class = \"col-md-3\">
                <input type=\"button\" style=\"float:right\" onclick=\"location.href='http://localhost/ratereviewtv.php?tvid=$tvid';\" class=\"btn btn-default btn-success\" value=\"Rate this Movie\" />
            </div>
            <div style=\"float:right\" class = \"col-md-3\">
                <button type=\"button\" style=\"margin-left:280px\"  onclick=\"location.href='http://localhost/addtowishlisttv.php?tvid=$tvid';\" class=\"btn btn-default btn-success\">Add to WishList</button>
            </div>";
            }
