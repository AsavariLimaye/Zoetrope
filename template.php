        ...
        <div class="row">
            ...
            <div class="col-md-2">
                ...
                <div style="margin-top:20px;margin-left:-50px" class="list-group">
                    <a href="./opening.html" class="list-group-item">Opening This Week</a>
                    <a href="./now_playing.html" class="list-group-item">Now Playing</a>
                    <a href="./coming_soon.html" class="list-group-item">Coming Soon</a>
                </div>
            </div>
